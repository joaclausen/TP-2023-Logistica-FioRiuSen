 ...
 * @author zapam
 */
public class AltaCamino extends javax.swing.JPanel {

    /**
     * Creates new form AltaCamino
     */
    private JFrame ventana;
    private JPanel padre;
    public AltaCamino(JFrame ventana, JPanel padre) {
        this.ventana = ventana;
        this.padre = padre;
        ventana.setTitle("Gestionar caminos - crear nuevo camino");
    ...
    GestorCamino gc =  new GestorCamino();
        ...
        if(control == true){
         int result = JOptionPane.showConfirmDialog(this,"¿Desea crear este nuevo camino?", "CONFIRMACION", JOptionPane.YES_NO_OPTION);
        switch (result){
